              ...
              <Row>
                {state.username === thisUser ? (
                  <h5 className="grey">
                    ...
                    <a href={`/image`}>uploading an image</a> or{" "}
                    <a href={`/generator`}>generating a random project.</a>
                  </h5>
                ) : (
              ...
              <div>
                ...
                {noMore ? (
                  ...
                  <LoadMore
                    disable={disable}
                    onClick={() =>
                      getUserInfo(projects[projects.length - 1].updatedAt)
                    }
                  />
                )}
              </div>
...
const CardBottomLinks = ({ id, index, onClickDelete }) => {
  return (
    <Row className={"profile-card-buttons"}>
      <p>
        <Link to={`/generator/${id}`}>edit</Link>
      </p>
      <p
